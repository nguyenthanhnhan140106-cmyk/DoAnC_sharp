...
(1, 'It`s New Music Friday!', 'friday', 'Những bản hit mới nhất được cập nhật mỗi thứ 6', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&h=240&fit=crop'),
(2, 'V-Sound', 'vsound', 'Nhạc Việt thịnh hành nhất', 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop'),
(3, 'Thế Giới Rap', 'rap', 'Nơi hội tụ các Rapper cực chất', 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=500&h=240&fit=crop');
...
(1,  'Thanh Tân',           'VƯƠNG BÌNH',
     ...
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&h=240&fit=crop', 9,
     '/lyrics/thanhtan.lrc',
     NOW()),
...
(2,  'Về bên anh',          'Jack',
     ...
     2, 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 2, '/lyrics/vebenanh.lrc',NOW()),
...
(3,  'Sóng gió',            'Jack,K-ICM',
     ...
     2, 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,
     '/lyrics/songgio.lrc',
     NOW()),
...
(4,  'Nơi này có anh',      'Sơn Tùng M-TP',
     ...
     2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 1,'/lyrics/noinaycoanh.lrc', NOW()),
...
(5,  'Ngày rời chuyến bay', 'Minh Huy, Pinny',
     ...
     1, 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&h=240&fit=crop', 10,'/lyrics/ngayroichuyenbay.lrc', NOW()),
...
(6,  'Mất kết nối',         'Dương Domic',
     ...
     2, 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=500&h=240&fit=crop', 6,'/lyrics/matketnoi.lrc', NOW()),
...
(7,  'Hồng nhan',           'Jack, K-ICM',
     ...
     2, 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,'/lyrics/hongnhan.lrc', NOW()),
...
(8,  'Em thua cô ta',       'Thiên Đình',
     ...
     1, 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&h=240&fit=crop', 11,'/lyrics/emthuacota.lrc', NOW()),
...
(9,  'Em',                  'Binz, SOONBIN',
     ...
     2, 'https://images.unsplash.com/photo-1516280440614-37939bbacd6a?w=500&h=240&fit=crop', 7,'/lyrics/em.lrc', NOW()),
...
(10, 'Đớn đau vô cùng',     'DatKaa',
     ...
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&h=240&fit=crop', 4,'/lyrics/dondauvocung.lrc', NOW()),
...
(11, 'Chờ anh về',          'ANH TRAI SAY HI',
     ...
     3, 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=500&h=240&fit=crop', 8,'/lyrics/choanhve.lrc', NOW()),
...
(12, 'Chất gây hại',        'Quang Hùng MasterD',
     ...
     2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 5,'/lyrics/chatgayhai.lrc', NOW()),
...
(13, 'Bạc phận',            'Jack, K-ICM',
     ...
     2, 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,'/lyrics/bacphan.lrc', NOW()),
...
(14, 'Túc Duyên Lofi',                'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/tucduyen.lrc', NOW()),
(15, 'Góc Nhỏ Trong Tim Lofi',       'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/gocnhotrongtim.lrc', NOW()),
(16, 'Hoang Mang Lofi',              'Elly',
     'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780660046/Screenshot_2026-06-05_184624_q5mqnh.png',
     'https://res.cloudinary.com/dawcwuwmm/video/upload/v1780660154/Hoang_Mang_Lofi_z1hp0i.mp3',
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12 ,'/lyrics/hoangmang.lrc', NOW()),
(17, 'Nhường Lại Nỗi Đau Lofi',     'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/nhuonglainoidau.lrc', NOW()),
(18, 'Em Thua Người Ta Nhiều Lắm Lofi', 'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/emthuanguoitanhieulam.lrc', NOW()),
(19, 'Bên Nhau Cả Đời Lofi',         'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/bennhaucadoi.lrc', NOW()),
(20, 'Ngôi Nhà Hạnh Phúc Lofi',      'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/ngoinhahanhphuc.lrc', NOW()),
(21, 'Dặm Trong Tim Lofi',           'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/damtrongtim.lrc', NOW()),
(22, 'Nửa Vầng Trăng Lofi',          'Elly',
     ...
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/nuavangtrang.lrc', NOW()),
(23, 'Anh Lofi',                     'Elly',
     'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780660046/Screenshot_2026-06-05_184624_q5mqnh.png',
     'https://res.cloudinary.com/dawcwuwmm/video/upload/v1780660149/Anh_Lofi_mfw3vv.mp3',
     '',
     1, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/anh.lrc', NOW()),
(24, 'Hiểu lầm', 'Changg',
     'https://res.cloudinary.com/dawcwuwmm/video/upload/v1780720503/Hi%E1%BB%83u_L%E1%BA%A7m_plbimo.mp3',
     NULL,
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_113834_dvharv.png', 13,NULL, NOW()),
(25, 'Em không hiểu', 'Changg',
     ...
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114001_oq3gwg.png', 13,NULL, NOW()),
(26, 'Anh đang nơi đâu', 'Changg',
     ...
     NULL,
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_113920_iq4rr0.png', 13,NULL, NOW()),
...
(28, 'Lỡ say Bye là Bye', 'Changg',
     ...
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_113948_cssrtd.png', 13,NULL, NOW()),
(29, 'Hướng Dương', 'Changg',
     ...
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114012_ixmbtl.png', 13,NULL, NOW()),
(30, 'Sài Gòn đâu có lạnh', 'Changg',
     ...
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114021_zvpewd.png', 13,NULL, NOW()),
(31, 'Định mệnh tình yêu', 'Changg',
     ...
     '',
     1, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721004/Screenshot_2026-06-06_114042_dvxz4p.png', 13,NULL, NOW()),
(32, 'Tuesday', 'Changg',
     ...
     '',
     3, 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721004/Screenshot_2026-06-06_114054_gyrsup.png', 13,NULL, NOW()),
...
(33, 'Trạm dừng chân', 'Jack',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 2, NULL, NOW()),
...
(34, 'Yêu kiều', 'Paris',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 15, NULL, NOW()),
...
(35, 'Quá khứ kia của anh', 'Andree Right Hand',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 16, NULL, NOW()),
...
(36, 'Người như anh xứng đáng cô đơn', 'Vũ Cát Tường',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 17, NULL, NOW()),
...
(37, 'Người im lặng gặp người hay nói', 'Hiếu Thứ Hai',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 18, NULL, NOW()),
...
(38, 'Nói anh nghe', 'Hoãng',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 19, NULL, NOW()),
...
(41, 'Không buông', 'Hngle',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 20, NULL, NOW()),
...
(44, 'Chờ anh về', 'Bray, Amee',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 21, NULL, NOW()),
...
(45, 'Cho con', 'Bray',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 22, NULL, NOW()),
...
(46, 'Cô ta', 'Parys',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 23, NULL, NOW()),
...
(48, 'BLA BLA BLA', 'gigi D`Agostino',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 24, NULL, NOW()),
...
(50, '100 cuộc gọi nhỡ', 'GREYD',
     ...
     NULL, 2, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 25, NULL, NOW()),
...
(52, 'Thủ đô Cypher', 'LowG',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 26, NULL, NOW()),
...
(53, 'Ex hate me', 'Bray, Amee',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 21, NULL, NOW()),
...
(54, 'She never know', 'JustaTee',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 27, NULL, NOW()),
...
(55, 'Kim phút kim giờ', 'Hiếu Thứ Hai, HURRYKNG',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 28, NULL, NOW()),
...
(56, 'Bạn đời', 'Karik',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 29, NULL, NOW()),
...
(57, 'Ngủ trong phòng thu', 'MCK',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 30, NULL, NOW()),
...
(58, 'Don''t côi', 'Ronboogz',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', NULL,NULL, NOW()),
...
(59, 'Ex sign', 'Hiếu Thứ Hai',
     ...
     NULL, 3, 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 18, NULL, NOW());
...
-- ─────────────────────────────────────────────────────────
-- 7. CÁC BẢNG BỔ SUNG (Notifications, PlayHistory, Favorite, MediaShare)
-- ─────────────────────────────────────────────────────────
