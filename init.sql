...
INSERT INTO songs (Id, Title, Artist, CoverUrl, AudioUrl, VideoUrl, Category, ArtistBanner, ArtistId, LyricsUrl, CreatedAt) VALUES 
(1,  'Thanh Tân',           'VƯƠNG BÌNH',
     ...
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&h=240&fit=crop', 9,
     '/lyrics/thanhtan.lrc',
     NOW()),
...
(3,  'Sóng gió',            'Jack-J97,K-ICM,ICM',
     ...
     'vsound', 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,
     '/lyrics/songgio.lrc',
     NOW()),
...
(4,  'Nơi này có anh',      'Sơn Tùng M-TP',
     ...
     'vsound', 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=500&h=240&fit=crop', 1,'/lyrics/noinaycoanh.lrc', NOW()),
...
(5,  'Ngày rời chuyến bay', 'Minh Huy, Pinny',
     ...
     'friday', 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500&h=240&fit=crop', 10,'/lyrics/ngayroichuyenbay.lrc', NOW()),
...
(7,  'Hồng nhan',           'Jack-J97, K-ICM, ICM',
     ...
     'vsound', 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,'/lyrics/hongnhan.lrc', NOW()),
...
(8,  'Em thua cô ta',       'Thiên Đình',
     ...
     'friday', 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&h=240&fit=crop', 11,'/lyrics/emthuacota.lrc', NOW()),
...
(9,  'Em',                  'Binz, SOONBIN',
     ...
     'vsound', 'https://images.unsplash.com/photo-1516280440614-37939bbacd6a?w=500&h=240&fit=crop', 7,'/lyrics/em.lrc', NOW()),
...
(10, 'Đớn đau vô cùng',     'DatKaa',
     ...
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500&h=240&fit=crop', 4,'/lyrics/dondauvocung.lrc', NOW()),
...
(11, 'Chờ anh về',          'ANH TRAI SAY HI',
     ...
     'rap', 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=500&h=240&fit=crop', 8,'/lyrics/choanhve.lrc', NOW()),
...
(13, 'Bạc phận',            'Jack-J97, K-ICM, ICM',
     ...
     'vsound', 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500&h=240&fit=crop', 3,'/lyrics/bacphan.lrc', NOW()),
...
(14, 'Túc Duyên Lofi',                'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/tucduyen.lrc', NOW()),
(15, 'Góc Nhỏ Trong Tim Lofi',       'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/gocnhotrongtim.lrc', NOW()),
(16, 'Hoang Mang Lofi',              'Elly',
     'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780660046/Screenshot_2026-06-05_184624_q5mqnh.png',
     'https://res.cloudinary.com/dawcwuwmm/video/upload/v1780660154/Hoang_Mang_Lofi_z1hp0i.mp3',
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12 ,'/lyrics/hoangmang.lrc', NOW()),
(17, 'Nhường Lại Nỗi Đau Lofi',     'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/nhuonglainoidau.lrc', NOW()),
(18, 'Em Thua Người Ta Nhiều Lắm Lofi', 'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/emthuanguoitanhieulam.lrc', NOW()),
(19, 'Bên Nhau Cả Đời Lofi',         'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/bennhaucadoi.lrc', NOW()),
(20, 'Ngôi Nhà Hạnh Phúc Lofi',      'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/ngoinhahanhphuc.lrc', NOW()),
(21, 'Dặm Trong Tim Lofi',           'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/damtrongtim.lrc', NOW()),
(22, 'Nửa Vầng Trăng Lofi',          'Elly',
     ...
     '',
     'friday', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&h=400&fit=crop', 12,'/lyrics/nuavangtrang.lrc', NOW()),
(23, 'Anh Lofi',                     'Elly',
     'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780660046/Screenshot_2026-06-05_184624_q5mqnh.png',
...
(25, 'Em không hiểu', 'Changg',
     ...
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114001_oq3gwg.png', 13,NULL, NOW()),
(26, 'Anh đang nơi đâu', 'Changg',
     ...
     NULL,
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_113920_iq4rr0.png', 13,NULL, NOW()),
...
(28, 'Lỡ say Bye là Bye', 'Changg',
     ...
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_113948_cssrtd.png', 13,NULL, NOW()),
(29, 'Hướng Dương', 'Changg',
     ...
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114012_ixmbtl.png', 13,NULL, NOW()),
(30, 'Sài Gòn đâu có lạnh', 'Changg',
     ...
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721003/Screenshot_2026-06-06_114021_zvpewd.png', 13,NULL, NOW()),
(31, 'Định mệnh tình yêu', 'Changg',
     ...
     '',
     'friday', 'https://res.cloudinary.com/dawcwuwmm/image/upload/v1780721004/Screenshot_2026-06-06_114042_dvxz4p.png', 13,NULL, NOW()),
(32, 'Tuesday', 'Changg',
