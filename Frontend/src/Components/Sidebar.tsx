...
// Định nghĩa Interface để đón nhận State quản lý đóng/mở từ Component Cha truyền xuống
...
export default function Sidebar({ isCollapsed, setIsCollapsed }: SidebarProps) {
  return (
    <aside className={`spotify-sidebar ${isCollapsed ? "collapsed" : ""}`}>
      ...
      {/* HEADER: Khi click vào nút này sẽ đảo ngược trạng thái thu gọn */}
      <div className="sidebar-header">
        <button 
          className="library-btn" 
          title={isCollapsed ? "Mở rộng Thư viện của bạn" : "Thu gọn Thư viện của bạn"}
          onClick={() => setIsCollapsed(!isCollapsed)} // 🟢 Bật/Tắt thu gọn tại đây
        >
          <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
            <path d="M3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zM15.5 2.134A1 1 0 0 0 14 3v18a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V6.464a1 1 0 0 0-.5-.866l-6-3.464zM9 2a1 1 0 0 0-1 1v18a1 1 0 1 0 2 0V3a1 1 0 0 0-1-1z"/>
          </svg>
          {/* 🟢 Nếu bị thu gọn (isCollapsed = true) -> Ẩn chữ "Thư viện của bạn" */}
          {!isCollapsed && <span className="library-text">Thư viện của bạn</span>}
        </button>

        {/* 🟢 Ẩn toàn bộ các nút nhỏ bên phải khi thu gọn để không bị méo giao diện */}
        {!isCollapsed && (
      ...
      {/* FILTERS: 🟢 Ẩn thanh chọn danh mục khi thu gọn */}
      {!isCollapsed && (
      ...
      {/* SEARCH & SORT: 🟢 Ẩn thanh tìm kiếm khi thu gọn */}
      {!isCollapsed && (
      ...
      <div className="sidebar-content">
        <div className="playlist-item" title="Danh sách phát của tôi #1">
          ...
          {/* 🟢 Nếu bị thu gọn -> Ẩn toàn bộ chữ tiêu đề, chỉ chừa lại đúng block icon vuông nốt nhạc */}
          {!isCollapsed && (
